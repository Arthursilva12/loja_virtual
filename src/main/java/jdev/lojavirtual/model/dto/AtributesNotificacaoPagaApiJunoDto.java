...
public class AtributesNotificacaoPagaApiJunoDto implements Serializable{
	...
	private ChargeNotificacaoPagaApiJunoDto charge = new ChargeNotificacaoPagaApiJunoDto();
	...
	public ChargeNotificacaoPagaApiJunoDto getCharge() {
		return charge;
	}

	public void setCharge(ChargeNotificacaoPagaApiJunoDto charge) {
		this.charge = charge;
	}
