...
public class ConteudoBoletoJuno implements Serializable {
	...
	private String installmenteLink;
	...
	public String getInstallmenteLink() {
		return installmenteLink;
	}

	public void setInstallmenteLink(String installmenteLink) {
		this.installmenteLink = installmenteLink;
	}
