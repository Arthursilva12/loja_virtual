...
public class Usuario implements UserDetails {
	...
	@JoinTable(name = "usuario_acesso", uniqueConstraints = @UniqueConstraint(
	...
	// Autoridade = acessos, ou seja ROLE_ADMIN, ROLE_SECRETARIO, ROLE_FINANCEIRO
	// Retorna uma coleção de cleses que implementa a interface de segurança
	@Override
