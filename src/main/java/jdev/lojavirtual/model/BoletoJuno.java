...
public class BoletoJuno implements Serializable{
	...
	// Codigo de controle do boleto
	private String code = "";
	
	// Imprime o boleto completo com todas as parcelas 
	private String link = "";
	
	// Mostra tela de checkout da juno com os boletos, pix e cartão pagos ou vencidos 
	private String checkouUrl = "";
	...
	public String getCheckouUrl() {
		return checkouUrl;
	}

	public void setCheckouUrl(String checkouUrl) {
		this.checkouUrl = checkouUrl;
	}
