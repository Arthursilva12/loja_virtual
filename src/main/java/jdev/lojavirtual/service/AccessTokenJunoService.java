...
public class AccessTokenJunoService {
	...
	public AccessTokenJunoAPI buscaTokenAtivo() {
		...
		try {
			AccessTokenJunoAPI accessTokenJunoAPI = (AccessTokenJunoAPI) entityManager
					.createNamedQuery("select a from AccessTokenJunoAPI a").setMaxResults(1).getSingleResult();
